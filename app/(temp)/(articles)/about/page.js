            ...
            <main className="text-[#222222] flex flex-col justify-center">
                <div className="flex justify-center mt-[10vw] xl:mt-32">
                    <div className="w-[384px] md:w-[50vw] xl:w-[640px]">
                        ...
                        <p className="text-xl">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Obcaecati harum reiciendis quod dolorem adipisci voluptates deleniti iste, odio necessitatibus at explicabo animi vitae ipsam, nulla dolorum magni error, laborum commodi!</p>
                        <br/>
                        <p className="text-xl">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Obcaecati harum reiciendis quod dolorem adipisci voluptates deleniti iste, odio necessitatibus at explicabo animi vitae ipsam, nulla dolorum magni error, laborum commodi!</p>
                        <br/>
                        <p className="text-xl">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Obcaecati harum reiciendis quod dolorem adipisci voluptates deleniti iste, odio necessitatibus at explicabo animi vitae ipsam, nulla dolorum magni error, laborum commodi!</p>
