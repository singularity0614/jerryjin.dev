            ...
            <main className="text-[#222222] flex flex-col justify-center">
                <div className="flex justify-center mt-[10vw] xl:mt-32">
                    <div className="w-full sm:w-[640px] m-2">
                        ...
                        <h4 className="text-xl font-medium mb-6">iPhone</h4>
                        ...
                        <h4 className="text-xl font-medium mb-6">Apple Watch</h4>
                        ...
                        <h4 className="text-xl font-medium mb-6">iPad</h4>
                        ...
                        <h4 className="text-xl font-medium mb-6">Mac</h4>
                        ...
                        <h4 className="text-xl font-medium mb-6">Laptop</h4>
